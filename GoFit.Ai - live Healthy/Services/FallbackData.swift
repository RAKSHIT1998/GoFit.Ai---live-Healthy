...
struct FallbackDataService {
    ...
    private func getAllWorkouts(activityLevel: String) -> [Exercise] {
        ...
        workouts.append(contentsOf: [
            ...
            Exercise(name: "Calf Raises", duration: 8, calories: 30, type: "strength", instructions: "Rise onto toes. Hold briefly. Lower with control. Can use weights for added resistance.", sets: 3, reps: "15-20", restTime: 30, difficulty: "beginner", muscleGroups: ["calves"], equipment: ["none"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Hammer Curls", duration: 10, calories: 40, type: "strength", instructions: "Curl dumbbells with neutral grip. Keep elbows still. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["biceps", "forearms"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Lateral Raises", duration: 10, calories: 35, type: "strength", instructions: "Raise dumbbells to sides. Keep slight bend in elbows. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Front Raises", duration: 10, calories: 35, type: "strength", instructions: "Raise dumbbells in front. Keep core engaged. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Chest Flyes", duration: 12, calories: 60, type: "strength", instructions: "Fly dumbbells out and together. Keep slight bend in elbows. Control the movement.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["chest"], equipment: ["dumbbells", "bench"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Goblet Squats", duration: 12, calories: 70, type: "strength", instructions: "Hold dumbbell at chest. Squat down keeping chest up. Drive through heels to stand.", sets: 3, reps: "12-15", restTime: 60, difficulty: "beginner", muscleGroups: ["legs", "glutes"], equipment: ["dumbbell"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Bent-Over Rows", duration: 12, calories: 75, type: "strength", instructions: "Bend forward, pull dumbbells to lower chest. Squeeze shoulder blades. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["back", "biceps"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Arnold Press", duration: 12, calories: 70, type: "strength", instructions: "Start with palms facing you. Rotate and press overhead. Reverse motion. Control throughout.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["shoulders"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
        ...
        // CORE (15 workouts)
        workouts.append(contentsOf: [
            Exercise(name: "Russian Twists", duration: 10, calories: 40, type: "strength", instructions: "Sit with knees bent. Lean back slightly. Rotate torso side to side. Keep core engaged.", sets: 3, reps: "20 each side", restTime: 45, difficulty: "beginner", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Bicycle Crunches", duration: 10, calories: 45, type: "strength", instructions: "Lie on back. Bring opposite elbow to knee. Alternate sides. Keep core engaged.", sets: 3, reps: "20 each side", restTime: 45, difficulty: "beginner", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Dead Bug", duration: 8, calories: 30, type: "strength", instructions: "Lie on back. Lower opposite arm and leg. Return. Alternate sides. Keep lower back pressed to floor.", sets: 3, reps: "10 each side", restTime: 30, difficulty: "beginner", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Leg Raises", duration: 10, calories: 40, type: "strength", instructions: "Lie on back. Raise legs to 90 degrees. Lower with control. Keep lower back pressed down.", sets: 3, reps: "12-15", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "hip flexors"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Side Plank", duration: 8, calories: 35, type: "strength", instructions: "Hold side plank. Keep body in straight line. Don't let hips sag. Hold for time.", sets: 3, reps: "30 seconds each side", restTime: 30, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Mountain Climbers", duration: 10, calories: 50, type: "cardio", instructions: "Start in plank. Alternate bringing knees to chest. Keep core engaged. Move quickly.", sets: nil, reps: "30 seconds", restTime: 30, difficulty: "intermediate", muscleGroups: ["core", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Flutter Kicks", duration: 8, calories: 35, type: "strength", instructions: "Lie on back. Alternately kick legs. Keep lower back pressed down. Keep core engaged.", sets: 3, reps: "30 seconds", restTime: 30, difficulty: "beginner", muscleGroups: ["core", "hip flexors"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Hollow Body Hold", duration: 8, calories: 30, type: "strength", instructions: "Lie on back. Raise shoulders and legs. Hold position. Keep core engaged. Breathe steadily.", sets: 3, reps: "30 seconds", restTime: 45, difficulty: "intermediate", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Reverse Crunches", duration: 8, calories: 35, type: "strength", instructions: "Lie on back. Bring knees to chest. Lift hips slightly. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "V-Ups", duration: 10, calories: 45, type: "strength", instructions: "Lie on back. Simultaneously raise torso and legs. Touch toes if possible. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Bird Dog", duration: 8, calories: 30, type: "strength", instructions: "Start on hands and knees. Extend opposite arm and leg. Hold, return. Alternate sides.", sets: 3, reps: "10 each side", restTime: 30, difficulty: "beginner", muscleGroups: ["core", "back"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Crunches", duration: 10, calories: 40, type: "strength", instructions: "Lie on back, knees bent. Lift shoulders toward knees. Lower with control. Don't pull neck.", sets: 3, reps: "15-20", restTime: 45, difficulty: "beginner", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Superman", duration: 8, calories: 30, type: "strength", instructions: "Lie face down. Lift arms and legs simultaneously. Hold briefly. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["core", "back"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
        ...
        workouts.append(contentsOf: [
            ...
            Exercise(name: "Mobility Flow", duration: 15, calories: 50, type: "flexibility", instructions: "Move through joint mobility exercises. Focus on range of motion. Move slowly.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "flexibility"], equipment: ["none"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
        ...
        workouts.append(contentsOf: [
            // More Cardio (10)
            Exercise(name: "Treadmill Incline Walk", duration: 30, calories: 200, type: "cardio", instructions: "Walk on treadmill at 5-8% incline. Maintain steady pace. Keep posture upright.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["legs", "cardio"], equipment: ["treadmill"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            ...
            Exercise(name: "Mountain Biking", duration: 45, calories: 400, type: "cardio", instructions: "Ride on trails or paths. Vary terrain. Maintain control and balance.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["mountain bike"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Water Aerobics", duration: 30, calories: 180, type: "cardio", instructions: "Perform aerobic exercises in water. Use water resistance. Low impact on joints.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["pool"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Zumba", duration: 45, calories: 350, type: "cardio", instructions: "Follow dance fitness routine. Move to music. Have fun and stay active!", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Aerobics Class", duration: 45, calories: 320, type: "cardio", instructions: "Follow aerobics routine. Keep moving continuously. Follow instructor cues.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Step Aerobics", duration: 30, calories: 280, type: "cardio", instructions: "Step up and down on platform. Follow routine. Keep core engaged.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["step platform"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cross Country Skiing", duration: 45, calories: 450, type: "cardio", instructions: "Ski using cross country technique. Maintain rhythm. Full body workout.", sets: nil, reps: "continuous", restTime: nil, difficulty: "advanced", muscleGroups: ["full body", "cardio"], equipment: ["skis"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Hiking", duration: 60, calories: 350, type: "cardio", instructions: "Hike on trails. Vary pace and terrain. Enjoy nature while exercising.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Tennis", duration: 45, calories: 380, type: "cardio", instructions: "Play tennis singles or doubles. Move quickly. Focus on form and strategy.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "cardio"], equipment: ["tennis racket"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            
            // More Strength (15)
            Exercise(name: "Barbell Squats", duration: 20, calories: 120, type: "strength", instructions: "Stand with feet shoulder-width. Lower with barbell on shoulders. Drive through heels to stand.", sets: 4, reps: "8-10", restTime: 90, difficulty: "advanced", muscleGroups: ["legs", "glutes"], equipment: ["barbell"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Bench Press", duration: 20, calories: 100, type: "strength", instructions: "Lie on bench. Lower barbell to chest. Press up. Keep core engaged.", sets: 4, reps: "8-10", restTime: 90, difficulty: "advanced", muscleGroups: ["chest", "triceps"], equipment: ["barbell", "bench"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Pull-ups", duration: 15, calories: 80, type: "strength", instructions: "Hang from bar. Pull body up until chin over bar. Lower with control.", sets: 3, reps: "as many as possible", restTime: 90, difficulty: "advanced", muscleGroups: ["back", "biceps"], equipment: ["pull-up bar"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Dips", duration: 12, calories: 60, type: "strength", instructions: "Support body on parallel bars. Lower by bending arms. Push back up.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["triceps", "shoulders"], equipment: ["parallel bars"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Leg Curls", duration: 15, calories: 70, type: "strength", instructions: "Curl weight with legs. Lower with control. Keep core engaged.", sets: 3, reps: "12-15", restTime: 60, difficulty: "intermediate", muscleGroups: ["hamstrings"], equipment: ["leg curl machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cable Crossovers", duration: 12, calories: 60, type: "strength", instructions: "Pull cables across body. Squeeze chest. Control the movement.", sets: 3, reps: "12-15", restTime: 60, difficulty: "intermediate", muscleGroups: ["chest"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Face Pulls", duration: 10, calories: 40, type: "strength", instructions: "Pull cable to face level. Squeeze shoulder blades. Control the return.", sets: 3, reps: "15-20", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders", "back"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cable Rows", duration: 15, calories: 80, type: "strength", instructions: "Pull cable to lower chest. Squeeze shoulder blades. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["back", "biceps"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Leg Extensions", duration: 12, calories: 60, type: "strength", instructions: "Extend legs with weight. Lower with control. Don't lock knees.", sets: 3, reps: "12-15", restTime: 60, difficulty: "beginner", muscleGroups: ["quadriceps"], equipment: ["leg extension machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cable Flyes", duration: 12, calories: 65, type: "strength", instructions: "Fly cables together. Squeeze chest. Control the movement.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["chest"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Tricep Pushdowns", duration: 10, calories: 45, type: "strength", instructions: "Push cable down. Keep elbows still. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["triceps"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cable Curls", duration: 10, calories: 40, type: "strength", instructions: "Curl cable to shoulders. Keep elbows still. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["biceps"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cable Lateral Raises", duration: 10, calories: 35, type: "strength", instructions: "Raise cable to side. Keep slight bend in elbows. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cable Crunches", duration: 10, calories: 40, type: "strength", instructions: "Curl down with cable. Squeeze abs. Return with control.", sets: 3, reps: "15-20", restTime: 45, difficulty: "beginner", muscleGroups: ["core"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Cable Woodchoppers", duration: 12, calories: 50, type: "strength", instructions: "Rotate cable diagonally. Engage core. Alternate sides.", sets: 3, reps: "12 each side", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            
            // More Core (10)
            Exercise(name: "Ab Wheel Rollout", duration: 10, calories: 50, type: "strength", instructions: "Roll wheel forward. Keep core engaged. Return to start.", sets: 3, reps: "10-12", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["ab wheel"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Hanging Leg Raises", duration: 12, calories: 60, type: "strength", instructions: "Hang from bar. Raise legs to 90 degrees. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["pull-up bar"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Dragon Flag", duration: 10, calories: 55, type: "strength", instructions: "Lie on bench. Raise body to vertical. Lower with control. Advanced movement.", sets: 3, reps: "5-8", restTime: 90, difficulty: "advanced", muscleGroups: ["core"], equipment: ["bench"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "L-Sit Hold", duration: 8, calories: 40, type: "strength", instructions: "Support body on parallel bars. Raise legs to L position. Hold as long as possible.", sets: 3, reps: "hold for time", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["parallel bars"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Pallof Press", duration: 10, calories: 45, type: "strength", instructions: "Press cable away from body. Resist rotation. Hold briefly. Return.", sets: 3, reps: "12 each side", restTime: 45, difficulty: "intermediate", muscleGroups: ["core"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Turkish Get-Up", duration: 15, calories: 70, type: "strength", instructions: "Complex movement from lying to standing with weight. Focus on form and control.", sets: 3, reps: "5 each side", restTime: 90, difficulty: "advanced", muscleGroups: ["full body", "core"], equipment: ["kettlebell"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Farmer's Walk", duration: 10, calories: 60, type: "strength", instructions: "Carry heavy weights. Walk forward. Keep core engaged. Maintain posture.", sets: 3, reps: "30-50 meters", restTime: 60, difficulty: "intermediate", muscleGroups: ["core", "grip"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Suitcase Carry", duration: 10, calories: 50, type: "strength", instructions: "Carry weight on one side. Walk forward. Resist lateral flexion.", sets: 3, reps: "30 meters each side", restTime: 60, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["dumbbell"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Plank to Down Dog", duration: 10, calories: 45, type: "strength", instructions: "Start in plank. Push hips up to down dog. Return to plank. Repeat.", sets: 3, reps: "10-12", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "shoulders"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            Exercise(name: "Side Plank with Rotation", duration: 10, calories: 50, type: "strength", instructions: "Hold side plank. Rotate torso. Return. Alternate sides.", sets: 3, reps: "10 each side", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
            ...
            Exercise(name: "Vinyasa Flow", duration: 30, calories: 150, type: "flexibility", instructions: "Flow through yoga poses. Link movement with breath. Smooth transitions.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil, sources: <#[CitationSource]?#>),
