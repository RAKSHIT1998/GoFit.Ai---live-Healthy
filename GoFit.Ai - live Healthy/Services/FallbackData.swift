...
struct FallbackDataService {
    ...
    private func getAllWorkouts(activityLevel: String) -> [Exercise] {
        ...
        workouts.append(contentsOf: [
            Exercise(name: "Brisk Walking", duration: 30, calories: 150, type: "cardio", instructions: "Walk at a brisk pace, maintaining steady speed. Keep head up and shoulders relaxed. Swing arms naturally.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["legs", "core"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Running", duration: 30, calories: 300, type: "cardio", instructions: "Start with 5-minute warm-up walk. Run at moderate pace for 20 minutes. Cool down with 5-minute walk.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "cardiovascular"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Jump Rope", duration: 15, calories: 200, type: "cardio", instructions: "Jump rope continuously for 30 seconds, rest 30 seconds. Repeat for 15 minutes. Keep core engaged.", sets: nil, reps: "30 seconds on, 30 seconds off", restTime: 30, difficulty: "intermediate", muscleGroups: ["full body", "cardio"], equipment: ["jump rope"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cycling", duration: 45, calories: 400, type: "cardio", instructions: "Cycle at moderate intensity. Maintain steady pace. Keep back straight and core engaged.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["legs", "cardio"], equipment: ["bicycle"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "HIIT Cardio Blast", duration: 20, calories: 250, type: "cardio", instructions: "Warm up 2 minutes. Alternate 30 seconds high intensity with 30 seconds rest. Exercises: jumping jacks, burpees, mountain climbers, high knees.", sets: nil, reps: "30 seconds on, 30 seconds off", restTime: 30, difficulty: "advanced", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Elliptical Training", duration: 30, calories: 280, type: "cardio", instructions: "Use elliptical at moderate resistance. Maintain steady pace. Keep posture upright.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["legs", "cardio"], equipment: ["elliptical"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Stair Climbing", duration: 20, calories: 200, type: "cardio", instructions: "Climb stairs at steady pace. Use handrail if needed. Focus on controlled movements.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "glutes", "cardio"], equipment: ["stairs"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Swimming", duration: 30, calories: 350, type: "cardio", instructions: "Swim laps using freestyle stroke. Maintain steady pace. Focus on breathing rhythm.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "cardio"], equipment: ["pool"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Rowing", duration: 25, calories: 300, type: "cardio", instructions: "Row at moderate pace. Keep back straight. Drive with legs, pull with arms.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "cardio"], equipment: ["rowing machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Dance Cardio", duration: 30, calories: 250, type: "cardio", instructions: "Follow dance routine or freestyle. Keep moving continuously. Have fun and stay active!", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Interval Running", duration: 25, calories: 320, type: "cardio", instructions: "Warm up 5 minutes. Alternate 2 minutes fast run with 1 minute walk. Repeat 5 times. Cool down 5 minutes.", sets: nil, reps: "2 min fast, 1 min walk", restTime: 60, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Burpees", duration: 15, calories: 180, type: "cardio", instructions: "Start standing. Drop to squat, jump back to plank, do push-up, jump feet forward, jump up. Repeat continuously.", sets: nil, reps: "30 seconds on, 30 seconds off", restTime: 30, difficulty: "advanced", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "High Knees", duration: 10, calories: 100, type: "cardio", instructions: "Run in place, bringing knees up high. Pump arms. Keep core engaged. Move quickly.", sets: nil, reps: "30 seconds on, 30 seconds off", restTime: 30, difficulty: "beginner", muscleGroups: ["legs", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Jumping Jacks", duration: 10, calories: 80, type: "cardio", instructions: "Jump feet apart while raising arms overhead. Jump back together. Repeat continuously.", sets: nil, reps: "30 seconds on, 30 seconds off", restTime: 30, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Box Jumps", duration: 15, calories: 150, type: "cardio", instructions: "Jump onto box or platform. Step down. Repeat. Start with lower height, progress gradually.", sets: nil, reps: "10-15 reps", restTime: 60, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["box"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Sprint Intervals", duration: 20, calories: 280, type: "cardio", instructions: "Warm up 3 minutes. Sprint 30 seconds, walk 90 seconds. Repeat 8 times. Cool down 3 minutes.", sets: nil, reps: "30 sec sprint, 90 sec walk", restTime: 90, difficulty: "advanced", muscleGroups: ["legs", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Kickboxing", duration: 30, calories: 300, type: "cardio", instructions: "Perform kickboxing combinations. Focus on form and power. Keep moving continuously.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Rowing Machine Intervals", duration: 25, calories: 320, type: "cardio", instructions: "Row hard for 1 minute, easy for 1 minute. Repeat 10 times. Focus on form.", sets: nil, reps: "1 min hard, 1 min easy", restTime: 60, difficulty: "intermediate", muscleGroups: ["full body", "cardio"], equipment: ["rowing machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "StairMaster", duration: 20, calories: 220, type: "cardio", instructions: "Use StairMaster at moderate pace. Maintain steady rhythm. Keep posture upright.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "glutes", "cardio"], equipment: ["stairmaster"], gifUrl: nil, videoUrl: nil)
        ])
        
        // STRENGTH (25 workouts)
        workouts.append(contentsOf: [
            Exercise(name: "Bodyweight Squats", duration: 10, calories: 50, type: "strength", instructions: "Stand with feet shoulder-width apart. Lower hips back and down as if sitting. Keep chest up. Return to standing.", sets: 3, reps: "12-15", restTime: 60, difficulty: "beginner", muscleGroups: ["legs", "glutes"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Push-ups", duration: 10, calories: 50, type: "strength", instructions: "Start in plank position. Lower body until chest nearly touches floor. Push back up. Keep core tight.", sets: 3, reps: "10-12", restTime: 60, difficulty: "beginner", muscleGroups: ["chest", "triceps", "shoulders"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Plank", duration: 5, calories: 30, type: "strength", instructions: "Hold plank position. Keep body in straight line from head to heels. Engage core. Breathe steadily.", sets: 3, reps: "30 seconds", restTime: 45, difficulty: "beginner", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Lunges", duration: 12, calories: 60, type: "strength", instructions: "Step forward into lunge. Lower back knee toward ground. Push through front heel to return. Alternate legs.", sets: 3, reps: "10 each leg", restTime: 60, difficulty: "beginner", muscleGroups: ["legs", "glutes"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Dumbbell Rows", duration: 15, calories: 80, type: "strength", instructions: "Bend forward slightly. Pull dumbbells to sides. Squeeze shoulder blades. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["back", "biceps"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Shoulder Press", duration: 12, calories: 70, type: "strength", instructions: "Press dumbbells overhead. Keep core engaged. Lower with control. Don't lock elbows.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["shoulders", "triceps"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Deadlifts", duration: 15, calories: 90, type: "strength", instructions: "Stand with feet hip-width. Hinge at hips, lower weight. Keep back straight. Drive through heels to stand.", sets: 3, reps: "8-10", restTime: 90, difficulty: "advanced", muscleGroups: ["legs", "back", "glutes"], equipment: ["barbell"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Bicep Curls", duration: 10, calories: 40, type: "strength", instructions: "Curl dumbbells to shoulders. Keep elbows still. Lower with control. Don't swing.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["biceps"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Tricep Dips", duration: 10, calories: 45, type: "strength", instructions: "Sit on edge of chair. Lower body by bending arms. Push back up. Keep elbows pointing back.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["triceps"], equipment: ["chair"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Leg Press", duration: 15, calories: 100, type: "strength", instructions: "Press weight with legs. Lower with control. Don't lock knees. Keep core engaged.", sets: 3, reps: "12-15", restTime: 60, difficulty: "intermediate", muscleGroups: ["legs", "glutes"], equipment: ["leg press machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Chest Press", duration: 12, calories: 80, type: "strength", instructions: "Press dumbbells from chest. Keep core engaged. Lower with control. Don't arch back excessively.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["chest", "triceps"], equipment: ["dumbbells", "bench"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Lat Pulldowns", duration: 12, calories: 75, type: "strength", instructions: "Pull bar to chest. Squeeze shoulder blades. Lower with control. Keep core engaged.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["back", "biceps"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Romanian Deadlifts", duration: 12, calories: 70, type: "strength", instructions: "Hinge at hips, lower weight. Keep legs mostly straight. Feel stretch in hamstrings. Return to standing.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["hamstrings", "glutes"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Overhead Squats", duration: 10, calories: 60, type: "strength", instructions: "Hold weight overhead. Squat down. Keep weight stable. Return to standing. Advanced movement.", sets: 3, reps: "8-10", restTime: 90, difficulty: "advanced", muscleGroups: ["legs", "shoulders", "core"], equipment: ["barbell"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Bulgarian Split Squats", duration: 12, calories: 65, type: "strength", instructions: "Place back foot on bench. Lunge down with front leg. Push through front heel. Alternate legs.", sets: 3, reps: "10 each leg", restTime: 60, difficulty: "intermediate", muscleGroups: ["legs", "glutes"], equipment: ["bench"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Calf Raises", duration: 8, calories: 30, type: "strength", instructions: "Rise onto toes. Hold briefly. Lower with control. Can use weights for added resistance.", sets: 3, reps: "15-20", restTime: 30, difficulty: "beginner", muscleGroups: ["calves"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Hammer Curls", duration: 10, calories: 40, type: "strength", instructions: "Curl dumbbells with neutral grip. Keep elbows still. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["biceps", "forearms"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Lateral Raises", duration: 10, calories: 35, type: "strength", instructions: "Raise dumbbells to sides. Keep slight bend in elbows. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Front Raises", duration: 10, calories: 35, type: "strength", instructions: "Raise dumbbells in front. Keep core engaged. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Chest Flyes", duration: 12, calories: 60, type: "strength", instructions: "Fly dumbbells out and together. Keep slight bend in elbows. Control the movement.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["chest"], equipment: ["dumbbells", "bench"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Goblet Squats", duration: 12, calories: 70, type: "strength", instructions: "Hold dumbbell at chest. Squat down keeping chest up. Drive through heels to stand.", sets: 3, reps: "12-15", restTime: 60, difficulty: "beginner", muscleGroups: ["legs", "glutes"], equipment: ["dumbbell"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Bent-Over Rows", duration: 12, calories: 75, type: "strength", instructions: "Bend forward, pull dumbbells to lower chest. Squeeze shoulder blades. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["back", "biceps"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Arnold Press", duration: 12, calories: 70, type: "strength", instructions: "Start with palms facing you. Rotate and press overhead. Reverse motion. Control throughout.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["shoulders"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Sumo Deadlifts", duration: 15, calories: 95, type: "strength", instructions: "Wide stance, toes pointed out. Lower weight between legs. Drive through heels to stand.", sets: 3, reps: "8-10", restTime: 90, difficulty: "advanced", muscleGroups: ["legs", "glutes", "back"], equipment: ["barbell"], gifUrl: nil, videoUrl: nil)
        ])
        
        // CORE (15 workouts)
        workouts.append(contentsOf: [
            Exercise(name: "Russian Twists", duration: 10, calories: 40, type: "strength", instructions: "Sit with knees bent. Lean back slightly. Rotate torso side to side. Keep core engaged.", sets: 3, reps: "20 each side", restTime: 45, difficulty: "beginner", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Bicycle Crunches", duration: 10, calories: 45, type: "strength", instructions: "Lie on back. Bring opposite elbow to knee. Alternate sides. Keep core engaged.", sets: 3, reps: "20 each side", restTime: 45, difficulty: "beginner", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Dead Bug", duration: 8, calories: 30, type: "strength", instructions: "Lie on back. Lower opposite arm and leg. Return. Alternate sides. Keep lower back pressed to floor.", sets: 3, reps: "10 each side", restTime: 30, difficulty: "beginner", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Leg Raises", duration: 10, calories: 40, type: "strength", instructions: "Lie on back. Raise legs to 90 degrees. Lower with control. Keep lower back pressed down.", sets: 3, reps: "12-15", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "hip flexors"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Side Plank", duration: 8, calories: 35, type: "strength", instructions: "Hold side plank. Keep body in straight line. Don't let hips sag. Hold for time.", sets: 3, reps: "30 seconds each side", restTime: 30, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Mountain Climbers", duration: 10, calories: 50, type: "cardio", instructions: "Start in plank. Alternate bringing knees to chest. Keep core engaged. Move quickly.", sets: nil, reps: "30 seconds", restTime: 30, difficulty: "intermediate", muscleGroups: ["core", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Flutter Kicks", duration: 8, calories: 35, type: "strength", instructions: "Lie on back. Alternately kick legs. Keep lower back pressed down. Keep core engaged.", sets: 3, reps: "30 seconds", restTime: 30, difficulty: "beginner", muscleGroups: ["core", "hip flexors"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Hollow Body Hold", duration: 8, calories: 30, type: "strength", instructions: "Lie on back. Raise shoulders and legs. Hold position. Keep core engaged. Breathe steadily.", sets: 3, reps: "30 seconds", restTime: 45, difficulty: "intermediate", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Reverse Crunches", duration: 8, calories: 35, type: "strength", instructions: "Lie on back. Bring knees to chest. Lift hips slightly. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "V-Ups", duration: 10, calories: 45, type: "strength", instructions: "Lie on back. Simultaneously raise torso and legs. Touch toes if possible. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Bird Dog", duration: 8, calories: 30, type: "strength", instructions: "Start on hands and knees. Extend opposite arm and leg. Hold, return. Alternate sides.", sets: 3, reps: "10 each side", restTime: 30, difficulty: "beginner", muscleGroups: ["core", "back"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Crunches", duration: 10, calories: 40, type: "strength", instructions: "Lie on back, knees bent. Lift shoulders toward knees. Lower with control. Don't pull neck.", sets: 3, reps: "15-20", restTime: 45, difficulty: "beginner", muscleGroups: ["core"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Superman", duration: 8, calories: 30, type: "strength", instructions: "Lie face down. Lift arms and legs simultaneously. Hold briefly. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["core", "back"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Woodchoppers", duration: 10, calories: 45, type: "strength", instructions: "Hold weight with both hands. Rotate torso diagonally from high to low. Alternate sides.", sets: 3, reps: "12 each side", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["dumbbell"], gifUrl: nil, videoUrl: nil)
        ])
        
        // FLEXIBILITY/YOGA (5 workouts)
        workouts.append(contentsOf: [
            Exercise(name: "Yoga Flow", duration: 30, calories: 120, type: "flexibility", instructions: "Flow through sun salutations. Focus on breath. Move mindfully. Hold poses as needed.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Stretching Routine", duration: 20, calories: 60, type: "flexibility", instructions: "Stretch major muscle groups. Hold each stretch 30 seconds. Don't bounce. Breathe deeply.", sets: nil, reps: "30 seconds per stretch", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Pilates Core", duration: 25, calories: 100, type: "strength", instructions: "Perform pilates exercises focusing on core. Move slowly and controlled. Focus on form.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["core", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Mobility Flow", duration: 15, calories: 50, type: "flexibility", instructions: "Move through joint mobility exercises. Focus on range of motion. Move slowly.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "flexibility"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Yin Yoga", duration: 45, calories: 80, type: "flexibility", instructions: "Hold passive stretches for 3-5 minutes each. Focus on relaxation. Breathe deeply.", sets: nil, reps: "3-5 minutes per pose", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil)
        ])
        
        // Additional workouts to reach 100+ (40+ more workouts)
        workouts.append(contentsOf: [
            // More Cardio (10)
            Exercise(name: "Treadmill Incline Walk", duration: 30, calories: 200, type: "cardio", instructions: "Walk on treadmill at 5-8% incline. Maintain steady pace. Keep posture upright.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["legs", "cardio"], equipment: ["treadmill"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Stationary Bike", duration: 30, calories: 250, type: "cardio", instructions: "Cycle at moderate resistance. Maintain steady pace. Adjust resistance as needed.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["legs", "cardio"], equipment: ["stationary bike"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Mountain Biking", duration: 45, calories: 400, type: "cardio", instructions: "Ride on trails or paths. Vary terrain. Maintain control and balance.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["mountain bike"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Water Aerobics", duration: 30, calories: 180, type: "cardio", instructions: "Perform aerobic exercises in water. Use water resistance. Low impact on joints.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["pool"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Zumba", duration: 45, calories: 350, type: "cardio", instructions: "Follow dance fitness routine. Move to music. Have fun and stay active!", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Aerobics Class", duration: 45, calories: 320, type: "cardio", instructions: "Follow aerobics routine. Keep moving continuously. Follow instructor cues.", sets: nil, reps: "continuous", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Step Aerobics", duration: 30, calories: 280, type: "cardio", instructions: "Step up and down on platform. Follow routine. Keep core engaged.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["step platform"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cross Country Skiing", duration: 45, calories: 450, type: "cardio", instructions: "Ski using cross country technique. Maintain rhythm. Full body workout.", sets: nil, reps: "continuous", restTime: nil, difficulty: "advanced", muscleGroups: ["full body", "cardio"], equipment: ["skis"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Hiking", duration: 60, calories: 350, type: "cardio", instructions: "Hike on trails. Vary pace and terrain. Enjoy nature while exercising.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["legs", "cardio"], equipment: ["none"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Tennis", duration: 45, calories: 380, type: "cardio", instructions: "Play tennis singles or doubles. Move quickly. Focus on form and strategy.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "cardio"], equipment: ["tennis racket"], gifUrl: nil, videoUrl: nil),
            
            // More Strength (15)
            Exercise(name: "Barbell Squats", duration: 20, calories: 120, type: "strength", instructions: "Stand with feet shoulder-width. Lower with barbell on shoulders. Drive through heels to stand.", sets: 4, reps: "8-10", restTime: 90, difficulty: "advanced", muscleGroups: ["legs", "glutes"], equipment: ["barbell"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Bench Press", duration: 20, calories: 100, type: "strength", instructions: "Lie on bench. Lower barbell to chest. Press up. Keep core engaged.", sets: 4, reps: "8-10", restTime: 90, difficulty: "advanced", muscleGroups: ["chest", "triceps"], equipment: ["barbell", "bench"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Pull-ups", duration: 15, calories: 80, type: "strength", instructions: "Hang from bar. Pull body up until chin over bar. Lower with control.", sets: 3, reps: "as many as possible", restTime: 90, difficulty: "advanced", muscleGroups: ["back", "biceps"], equipment: ["pull-up bar"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Dips", duration: 12, calories: 60, type: "strength", instructions: "Support body on parallel bars. Lower by bending arms. Push back up.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["triceps", "shoulders"], equipment: ["parallel bars"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Leg Curls", duration: 15, calories: 70, type: "strength", instructions: "Curl weight with legs. Lower with control. Keep core engaged.", sets: 3, reps: "12-15", restTime: 60, difficulty: "intermediate", muscleGroups: ["hamstrings"], equipment: ["leg curl machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cable Crossovers", duration: 12, calories: 60, type: "strength", instructions: "Pull cables across body. Squeeze chest. Control the movement.", sets: 3, reps: "12-15", restTime: 60, difficulty: "intermediate", muscleGroups: ["chest"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Face Pulls", duration: 10, calories: 40, type: "strength", instructions: "Pull cable to face level. Squeeze shoulder blades. Control the return.", sets: 3, reps: "15-20", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders", "back"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cable Rows", duration: 15, calories: 80, type: "strength", instructions: "Pull cable to lower chest. Squeeze shoulder blades. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["back", "biceps"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Leg Extensions", duration: 12, calories: 60, type: "strength", instructions: "Extend legs with weight. Lower with control. Don't lock knees.", sets: 3, reps: "12-15", restTime: 60, difficulty: "beginner", muscleGroups: ["quadriceps"], equipment: ["leg extension machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cable Flyes", duration: 12, calories: 65, type: "strength", instructions: "Fly cables together. Squeeze chest. Control the movement.", sets: 3, reps: "10-12", restTime: 60, difficulty: "intermediate", muscleGroups: ["chest"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Tricep Pushdowns", duration: 10, calories: 45, type: "strength", instructions: "Push cable down. Keep elbows still. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["triceps"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cable Curls", duration: 10, calories: 40, type: "strength", instructions: "Curl cable to shoulders. Keep elbows still. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["biceps"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cable Lateral Raises", duration: 10, calories: 35, type: "strength", instructions: "Raise cable to side. Keep slight bend in elbows. Lower with control.", sets: 3, reps: "12-15", restTime: 45, difficulty: "beginner", muscleGroups: ["shoulders"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cable Crunches", duration: 10, calories: 40, type: "strength", instructions: "Curl down with cable. Squeeze abs. Return with control.", sets: 3, reps: "15-20", restTime: 45, difficulty: "beginner", muscleGroups: ["core"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Cable Woodchoppers", duration: 12, calories: 50, type: "strength", instructions: "Rotate cable diagonally. Engage core. Alternate sides.", sets: 3, reps: "12 each side", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            
            // More Core (10)
            Exercise(name: "Ab Wheel Rollout", duration: 10, calories: 50, type: "strength", instructions: "Roll wheel forward. Keep core engaged. Return to start.", sets: 3, reps: "10-12", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["ab wheel"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Hanging Leg Raises", duration: 12, calories: 60, type: "strength", instructions: "Hang from bar. Raise legs to 90 degrees. Lower with control.", sets: 3, reps: "10-12", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["pull-up bar"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Dragon Flag", duration: 10, calories: 55, type: "strength", instructions: "Lie on bench. Raise body to vertical. Lower with control. Advanced movement.", sets: 3, reps: "5-8", restTime: 90, difficulty: "advanced", muscleGroups: ["core"], equipment: ["bench"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "L-Sit Hold", duration: 8, calories: 40, type: "strength", instructions: "Support body on parallel bars. Raise legs to L position. Hold as long as possible.", sets: 3, reps: "hold for time", restTime: 60, difficulty: "advanced", muscleGroups: ["core"], equipment: ["parallel bars"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Pallof Press", duration: 10, calories: 45, type: "strength", instructions: "Press cable away from body. Resist rotation. Hold briefly. Return.", sets: 3, reps: "12 each side", restTime: 45, difficulty: "intermediate", muscleGroups: ["core"], equipment: ["cable machine"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Turkish Get-Up", duration: 15, calories: 70, type: "strength", instructions: "Complex movement from lying to standing with weight. Focus on form and control.", sets: 3, reps: "5 each side", restTime: 90, difficulty: "advanced", muscleGroups: ["full body", "core"], equipment: ["kettlebell"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Farmer's Walk", duration: 10, calories: 60, type: "strength", instructions: "Carry heavy weights. Walk forward. Keep core engaged. Maintain posture.", sets: 3, reps: "30-50 meters", restTime: 60, difficulty: "intermediate", muscleGroups: ["core", "grip"], equipment: ["dumbbells"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Suitcase Carry", duration: 10, calories: 50, type: "strength", instructions: "Carry weight on one side. Walk forward. Resist lateral flexion.", sets: 3, reps: "30 meters each side", restTime: 60, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["dumbbell"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Plank to Down Dog", duration: 10, calories: 45, type: "strength", instructions: "Start in plank. Push hips up to down dog. Return to plank. Repeat.", sets: 3, reps: "10-12", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "shoulders"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Side Plank with Rotation", duration: 10, calories: 50, type: "strength", instructions: "Hold side plank. Rotate torso. Return. Alternate sides.", sets: 3, reps: "10 each side", restTime: 45, difficulty: "intermediate", muscleGroups: ["core", "obliques"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            
            // More Flexibility/Yoga (5)
            Exercise(name: "Power Yoga", duration: 45, calories: 200, type: "flexibility", instructions: "Dynamic yoga flow. Build strength and flexibility. Move with breath.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Hot Yoga", duration: 60, calories: 300, type: "flexibility", instructions: "Yoga in heated room. Increased flexibility. Stay hydrated.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Vinyasa Flow", duration: 30, calories: 150, type: "flexibility", instructions: "Flow through yoga poses. Link movement with breath. Smooth transitions.", sets: nil, reps: "continuous", restTime: nil, difficulty: "intermediate", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Restorative Yoga", duration: 45, calories: 60, type: "flexibility", instructions: "Gentle, supported poses. Focus on relaxation. Hold poses 5-10 minutes.", sets: nil, reps: "5-10 minutes per pose", restTime: nil, difficulty: "beginner", muscleGroups: ["full body", "flexibility"], equipment: ["mat", "props"], gifUrl: nil, videoUrl: nil),
            Exercise(name: "Ashtanga Yoga", duration: 60, calories: 250, type: "flexibility", instructions: "Traditional yoga sequence. Challenging poses. Build strength and flexibility.", sets: nil, reps: "continuous", restTime: nil, difficulty: "advanced", muscleGroups: ["full body", "flexibility"], equipment: ["mat"], gifUrl: nil, videoUrl: nil)
        ])
